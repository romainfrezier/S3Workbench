...
Only MinIO is covered by the local automated environment. AWS S3, R2, Wasabi, Backblaze B2, and other providers require separate credentials and are not claimed as tested by this suite.
